...
- 发生隐式类型转换的情况
  ...
  ![1662452840869](D:\c_c++\Note\c、c++语言基础\assets\1662452840869.png)
...
- 其他隐式类型转换
  ...
  - 数组转换为指针（数组自动转换为指向首元素的指针）
    ...
    ![1662455313537](D:\c_c++\Note\c、c++语言基础\assets\1662455313537.png)
...
- 大小
  ...
  c.resize();
  ```
  ![1661734554703](D:\c_c++\Note\c、c++语言基础\assets\1661734554703.png)
...
![1661732525112](D:\c_c++\Note\c、c++语言基础\assets\1661732525112.png)
...
![1661733906751](D:\c_c++\Note\c、c++语言基础\assets\1661733906751.png)

![1661733105803](D:\c_c++\Note\c、c++语言基础\assets\1661733105803.png)



- 访问元素

  ![1661733043806](D:\c_c++\Note\c、c++语言基础\assets\1661733043806.png)
...
![1661734764501](D:\c_c++\Note\c、c++语言基础\assets\1661734764501.png)
...
- iostream迭代器
  ...
  ![1661832514257](D:\c_c++\Note\c、c++语言基础\assets\1661832514257.png)

- 反向迭代器

  - 反向迭代器是从后往前递增的，即递增含义和原本迭代器递增颠倒。
  - 一个反向迭代器可以通过调用类方法中的base进行反向，使其正向递增。
  - ![1661832921393](D:\c_c++\Note\c、c++语言基础\assets\1661832921393.png)
...
- 字符串搜索
  ...
  ![1661742177613](D:\c_c++\Note\c、c++语言基础\assets\1661742177613.png)

![1661742162708](D:\c_c++\Note\c、c++语言基础\assets\1661742162708.png)

- string比较campare函数

  ![1661744023654](D:\c_c++\Note\c、c++语言基础\assets\1661744023654.png)
...
- 数值转换
  ...
  ![1661744256596](D:\c_c++\Note\c、c++语言基础\assets\1661744256596.png)
...
- 顺序容器适配器：
  ...
  - priority_queue：默认底层实现为vector，也可选择deque
    ...
    ![1661778131368](D:\c_c++\Note\c、c++语言基础\assets\1661778131368.png)

    tip：选择什么底层数据结构是看需要什么操作，多插入删除选择list，多随机访问选择deque和vector

- 所有容器适配器支持的操作和类型

  ![1661778082403](D:\c_c++\Note\c、c++语言基础\assets\1661778082403.png)
...
- ![1661910603771](D:\c_c++\Note\c、c++语言基础\assets\1661910603771.png)
...
![1661910812811](D:\c_c++\Note\c、c++语言基础\assets\1661910812811.png)
...
- 添加元素
  ...
  - insert
    ...
    - ![1661912638136](D:\c_c++\Note\c、c++语言基础\assets\1661912638136.png)
  ...
  - 删除元素
    ...
    - ![1661913194602](D:\c_c++\Note\c、c++语言基础\assets\1661913194602.png)

  - map的下标操作

    - 对一个map使用下标操作，其行为与数组或vector上的下标操作很不相同：使用一个不在容器中的关键字作为下标，会添加一个具有此关键字的元素到map中。

    - ![1661913478923](D:\c_c++\Note\c、c++语言基础\assets\1661913478923.png)
  ...
  - 访问元素
    ...
    ![1661913882559](D:\c_c++\Note\c、c++语言基础\assets\1661913882559.png)
...
![1661918670670](D:\c_c++\Note\c、c++语言基础\assets\1661918670670.png)

![1661918728889](D:\c_c++\Note\c、c++语言基础\assets\1661918728889.png)



#### 管理桶

![1661916387913](D:\c_c++\Note\c、c++语言基础\assets\1661916387913.png)



## 泛型算法

![1661823769518](D:\c_c++\Note\c、c++语言基础\assets\1661823769518.png)

![1661823713732](D:\c_c++\Note\c、c++语言基础\assets\1661823713732.png)
...
- 向算法传递函数
  ...
  - 比如sort的一个重载版本接收第三个参数，该参数是一个谓词，该谓词是一个可调用的表达式，返回结果是一个能用作条件的值
    ...
    ![1661825513729](D:\c_c++\Note\c、c++语言基础\assets\1661825513729.png)
...
- lambuda表达式
  ...
  - lambda捕获和返回
    ...
    ![1661828292216](D:\c_c++\Note\c、c++语言基础\assets\1661828292216.png)

    - 隐式捕获，通过在捕获列表中写一个&或者=，&告诉编译器采用引用捕获，=采用值捕获，并且可以混用隐式捕获和显示捕获，==并且混用必须是一个是引用捕获一个是值捕获==

      ![1661828659709](D:\c_c++\Note\c、c++语言基础\assets\1661828659709.png)

    - 可变lambda，希望值被拷贝的变量值可以被改变，可以在参数列表后加上mutable

      ![1661828863398](D:\c_c++\Note\c、c++语言基础\assets\1661828863398.png)
...
- 泛型算法结构
  ...
  - ![1661862344452](D:\c_c++\Note\c、c++语言基础\assets\1661862344452.png)
...
![1661932036288](D:\c_c++\Note\c、c++语言基础\assets\1661932036288.png)

####make_shared函数

![1661933211499](D:\c_c++\Note\c、c++语言基础\assets\1661933211499.png)
...
- shared_ptr和new结合使用
  ...
  - ![1661947081461](D:\c_c++\Note\c、c++语言基础\assets\1661947081461.png)

    ![1661947101043](d:\Temp\1661947101043.png)
...
![1661996077673](D:\c_c++\Note\c、c++语言基础\assets\1661996077673.png)

![1661996090825](d:\Temp\1661996090825.png)
...
- unique_ptr操作
  ...
  ![1661996990182](D:\c_c++\Note\c、c++语言基础\assets\1661996990182.png)

> 虽然不能拷贝和赋值，但是可以调用release或者reset将指针的所有权从一个非const的unique_ptr转移到另一个上

![1661997243696](D:\c_c++\Note\c、c++语言基础\assets\1661997243696.png)

- reset函数

  ![1661997361630](D:\c_c++\Note\c、c++语言基础\assets\1661997361630.png)

- release函数

  ![1661997309885](D:\c_c++\Note\c、c++语言基础\assets\1661997309885.png)

- 传递unique_ptr参数和返回unique_ptr

  > 不能拷贝和赋值unique_ptr，但是有个例外是可以拷贝和赋值一个将要销毁的unique_ptr

  ![1661998169124](D:\c_c++\Note\c、c++语言基础\assets\1661998169124.png)
...
![1662109896836](D:\c_c++\Note\c、c++语言基础\assets\1662109896836.png)
...
![1662110945642](D:\c_c++\Note\c、c++语言基础\assets\1662110945642.png)
...
![1662111036665](D:\c_c++\Note\c、c++语言基础\assets\1662111036665.png)
...
![1662111310018](D:\c_c++\Note\c、c++语言基础\assets\1662111310018.png)
...
- ![1662118228780](D:\c_c++\Note\c、c++语言基础\assets\1662118228780.png)
...
- 使用完这些用allocator类分配的对象后，需要调用destroy进行销毁
...
- 拷贝和填充未初始化内存的算法
  ...
  ![1662119445994](D:\c_c++\Note\c、c++语言基础\assets\1662119445994.png)
...
- 定义一个返回this对象的函数
  ...
  ![1662268059906](D:\c_c++\Note\c、c++语言基础\assets\1662268059906.png)
...
- 构造函数不能被声明为const，在创建一个对象直到初始化完成才能取得常量属性，构造函数在const对象的构造过程中可以向其写值。
...
- 默认和自定义构造函数
  ...
  ![1662272273771](D:\c_c++\Note\c、c++语言基础\assets\1662272273771.png)
...
- 默认构造函数的作用
  ...
  ![1662352262562](D:\c_c++\Note\c、c++语言基础\assets\1662352262562.png)
...
- 构造函数初始值列表
  ...
  ![1662272716367](D:\c_c++\Note\c、c++语言基础\assets\1662272716367.png)
...
- 构造函数初始值列表
  ...
  - 构造函数的初始值有时必不可少
    ...
    **存在const成员变量或者存在引用时都必须在定义对象时马上进行初始化，必须在初始值列表中就进行初始化，在构造函数体中的赋值不是初始化，是等号赋值。**
    ...
    ![1662349526141](D:\c_c++\Note\c、c++语言基础\assets\1662349526141.png)
...
![1662276957771](D:\c_c++\Note\c、c++语言基础\assets\1662276957771.png)
...
![1662276989198](D:\c_c++\Note\c、c++语言基础\assets\1662276989198.png)
...
- 基于const的重载
  ...
  ![1662341121657](D:\c_c++\Note\c、c++语言基础\assets\1662341121657.png)
...
- 函数的返回类型在函数名之前，成员函数定义在类外部时，返回类型使用的名字位于类的作用域之外，返回类型需要加上类的作用域（也就是函数名前和返回类型前都需要加上类作用域）
  ...
  ![1662343800068](D:\c_c++\Note\c、c++语言基础\assets\1662343800068.png)

- 名字查找和类作用域

  ![1662344113021](D:\c_c++\Note\c、c++语言基础\assets\1662344113021.png)
  ...
  - 类方法是最后再定义的，类数据类型和数据成员先声明和定义的。
    ...
    ![1662345286547](D:\c_c++\Note\c、c++语言基础\assets\1662345286547.png)
...
- 满足以下条件为聚合类
  ...
  ![1662460935634](D:\c_c++\Note\c、c++语言基础\assets\1662460935634.png)
